...
export const PROTOCOL_PROFILES: Record<string, ProtocolProfile> = {
  chained: {
    ...
    crossViewSafety:     '3-chain rule: commit is implicit once 3 consecutive views form a parent-QC chain; lockedQC carried forward via NEW_VIEW',
  ...
  tendermint: {
    ...
    faultsHandled:       ['WRONG_BLOCK', 'EQUIVOCATE', 'DELAY'],
